    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonFragment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DetailRecipe fragment = DetailRecipe.newInstance(new Recipe("Mi Receta", "Franco Pesce", 60, "http://www.lajuvenilpastas.com.ar/wp-content/uploads/2015/08/pastas_2_808x560.jpg"));
